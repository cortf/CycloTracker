  ...
  return (
    <footer className="provenance">
      ...
      <table className="provenance-table">
        <caption className="sr-only">Data sources and last fetch times</caption>
        <thead>
          <tr>
          ...
          {sources.map((s) => (
            <tr key={s.key}>
              <th scope="row">
                ...
                {s.license ? <span className="lic"> · {s.license}</span> : null}
              </th>
      ...
      <p className="provenance-note">
        Counts are provisional NNDSS weekly case reports and are revised in later weeks. Missing is missing —
        no value is imputed. See the methodology page for comparability caveats.
      </p>
    </footer>
  );
}
